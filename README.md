...
This is a minimal fund raising smart contract which allow users to fund the contract (Minimum $50) and the owner of the contract can withdraw it. This project is using chainlink AggregatorV3 contract to fetch the ETH/USD price.
...
```
git clone https://github.com/0xSravan03/foundry-fund-me.git
cd foundry-fund-me
forge build
```
